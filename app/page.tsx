...
export default function Home() {
  ...
  function getActiveUser() {
    ...
    return { driverId, username, fullName, appRole: 'driver' as AppRole }
  }
  ...
  }, [useLocalTestMode, activeTestProfile, isAdmin])
  ...
  }, [rides, searchText, filterRole, filterDate, isAdmin, useLocalTestMode, activeTestProfile])
    ...
    <main style={styles.page}>
      <div style={styles.headerCard}>
        ...
        <p style={styles.subtitle}>
          Compile-ready son versiya: profil, elan, request, chat, review və admin CRUD panel.
        </p>
      </div>
      ...
      <section style={styles.sectionCard}>
        ...
        {useLocalTestMode && (
          <div style={styles.chipRow}>
            ...
            <button
              type="button"
              onClick={() => setActiveTestProfile('3')}
              style={activeTestProfile === '3' ? styles.chipAdmin : styles.chip}
            >
              Profil 3 (Admin)
            </button>
          </div>
        ...
        <p style={styles.infoRow}>
          <strong>Rol:</strong> {getAppRoleLabel(currentUser.appRole)}
        </p>
      </section>
        ...
        <>
          ...
          {adminSection === 'overview' && (
            <section style={styles.sectionCard}>
              ...
              <div style={styles.statsGrid}>
                <div style={styles.adminStatsCard}>
                  <p style={styles.statLabel}>Users</p>
                  <p style={styles.statValue}>{adminUsers.length}</p>
                </div>
                <div style={styles.adminStatsCard}>
                  <p style={styles.statLabel}>Rides</p>
                  <p style={styles.statValue}>{allRidesAdmin.length}</p>
                </div>
                <div style={styles.adminStatsCard}>
                  <p style={styles.statLabel}>Requests</p>
                  <p style={styles.statValue}>{allRideRequestsAdmin.length}</p>
                </div>
                <div style={styles.adminStatsCard}>
                  <p style={styles.statLabel}>Messages</p>
                  <p style={styles.statValue}>{allMessagesAdmin.length}</p>
                </div>
                <div style={styles.adminStatsCard}>
                  <p style={styles.statLabel}>Reviews</p>
                  <p style={styles.statValue}>{allReviewsAdmin.length}</p>
                </div>
                <div style={styles.adminStatsCard}>
                  <p style={styles.statLabel}>Reports</p>
                  <p style={styles.statValue}>{adminReports.length}</p>
                </div>
              </div>
            </section>
          )}
